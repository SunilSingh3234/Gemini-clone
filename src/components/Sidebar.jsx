    ...
    <div className='min-h-screen inline-flex flex-col justify-between bg-[#e4e7eb] py-[25px] px-[15px]'>
      ...
      <div>
        ...
        {extended && <div className='flex flex-col'>
          ...
          <div className='flex items-center gap-2 p-2 pr-10 rounded-[50px] text-slate-700 cursor-pointer hover:bg-gray-300'><FaMessage className='text-2xl' />
            <p>What is Python?</p></div>
        </div>}
      </div>
      <div className='flex flex-col gap-2'>
        <div className='flex items-center gap-2p-2 pr-10 rounded-[50px] text-slate-700 cursor-pointer hover:bg-gray-300'>
